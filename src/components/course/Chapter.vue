  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="userlist" border stripe>
        ...
        <el-table-column label="章节名称" prop="lessonTitle"></el-table-column>
    ...
    <el-dialog title="添加章节" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
      ...
      <el-form
        ...
        label-width="100px"
      >
        <el-form-item label="章节名称" prop="lessonTitle">
          <el-input v-model="addUserForm.lessonTitle"></el-input>
        </el-form-item>
    ...
    >
      ...
      >
      <el-form-item label="章节名称" prop="lessonTitle">
          <el-input v-model="editUserForm.lessonTitle"></el-input>
        </el-form-item>
    ...
    <el-dialog title="学期设置" :visible.sync="setRoleDialogVisible" width="50%" @close="setRoleDialogClosed">
      <div>
        <p>章节：{{userInfo.camptitle}}</p>
        <p>章节简介：{{userInfo.role_name}}</p>
        <p>
          分配角色：
          <el-select
...
//     },
    ...
    addUser () {
      ...
      this.$refs.addUserFormRef.validate(async valid => {
        ...
        // 表单预校验失败
        if (!valid) return
        const { data: res } = await this.$http.post('lesson/', this.addUserForm)
        if (res.code !== 200) {
